...
public class FacultyAttendanceVoiceHomeC{

    @FXML private TextField courseCode;
    @FXML private DatePicker date;

    public void takeVoiceAttendance(ActionEvent event) throws IOException
    {
            ...
            if(rs.next())
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        FacultyAttendanceVoiceTakeC.setValues(code, datef);
                        s.changeSceneTo(event, "FacultyAttendanceVoiceTake.fxml");
                    }
                }
            }
            else
