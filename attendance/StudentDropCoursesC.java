...
public class StudentDropCoursesC implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle)
    {
        event = new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e)
            {
                ...
                Alert alert= new Alert(Alert.AlertType.CONFIRMATION, "Are you sure you want to drop this course? ", ButtonType.YES, ButtonType.NO);
                ...
                if (result.get() == ButtonType.YES) {
                    ...
                    try {
                        ...
                        String query = "DELETE FROM classes WHERE courseCode='"+ code +"' AND regNumber='"+LoggedInStudent.regno+"'";
                        PreparedStatement ps = con.prepareStatement(query);
                        int count = ps.executeUpdate(query);
                        if (count != 1) System.out.println("Unsubscribe Failed");

                        String query2 = "DELETE FROM attendance WHERE courseCode='"+ code +"' AND regNumber='"+LoggedInStudent.regno+"'";
    ...
    public ObservableList<CourseSchema> getCourses() throws Exception
    {
        ...
        String query= "SELECT * FROM courses,classes WHERE (classes.regNumber='"+ LoggedInStudent.regno+"' AND classes.courseCode=courses.code)";
