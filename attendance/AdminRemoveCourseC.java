...
public class AdminRemoveCourseC implements Initializable {
        ...
        event = new EventHandler<ActionEvent>() {
            public void handle(ActionEvent e)
            {
                ...
                try {
                    ...
                    if (count != 1) System.out.println("Course Deletion Failed.");
                    else
                    {
                        Alert a= new Alert(Alert.AlertType.INFORMATION);
                        a.setContentText("Course Deleted.");
                        a.show();
                    }
                    con.close();
                }
                catch (Exception ex)
                {
                    ...
                    a.setContentText("Course Deletion Failed.");
                    a.show();
                }
            }
        };
